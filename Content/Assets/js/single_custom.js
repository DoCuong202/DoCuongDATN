		...
		if ($('.user_star_rating li').length) {
			...
			stars.each(function () {
				...
				star.on('click', function () {
					...
					// Gửi giá trị số sao lên máy chủ nếu cần
					// $.ajax({
					//     url: '/your-server-endpoint',
					//     method: 'POST',
					//     data: { stars: selectedStars },
					//     success: function (response) {
					//         console.log('Đánh giá đã được gửi lên máy chủ.');
					//     },
					//     error: function (error) {
					//         console.error('Lỗi khi gửi đánh giá lên máy chủ.');
					//     }
					// });
				});
			});
